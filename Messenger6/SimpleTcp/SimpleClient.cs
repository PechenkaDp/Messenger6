...
namespace Messenger6.SimpleTcp
{
    public class SimpleClient
    {
        ...
        public async Task<bool> Connect()
        {
            ...
            {
                Console.WriteLine("Соединение " + e.Message);
            }
        ...
        private bool TrySendObject(object obj)
        {
            ...
            {
                Console.WriteLine("Попробуйте получить объект " + e.Message);
                return false;
            }
        }
        ...
        public bool TrySendMessage(string message)
        {
            ...
            {
                Console.WriteLine("Попробуйте отправить сообщение " + e.Message);
                return false;
            }
        }
        ...
        public string RecieveGuid()
        {
            ...
            {
                Console.WriteLine("Получите руководство " + e.Message);
                return null;
            }
        }
        ...
        public bool IsSocketConnected()
        {
            ...
            {
                Console.WriteLine("Подключен ли сокет " + e.Message);
                return false;
            }
        }
